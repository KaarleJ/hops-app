...
type CourseFields = { name: unknown, code: unknown, ects: unknown, year: unknown, startPeriod: unknown, endPeriod: unknown};

export const toCourse = ({ name, code, ects, year, startPeriod, endPeriod }: CourseFields): NewCourse  => {
